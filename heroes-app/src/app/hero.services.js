...
var HeroService = (function () {
    ...
    HeroService.prototype.update = function (hero) {
        ...
        return this.http.put(url, JSON.stringify(hero), { headers: this.headers }).toPromise().then(function () { return hero; });
    };
    ...
    HeroService.prototype.deleteHero = function (hero) {
        var url = this.heroesUrl + "/" + hero.id;
        return this.http.delete(url, { headers: this.headers }).toPromise().then(function () { return null; });
    };
    return HeroService;
}());
